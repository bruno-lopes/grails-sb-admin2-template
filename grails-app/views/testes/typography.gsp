    ...
    <div class="col-lg-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p>This is an example of standard paragraph text. This is an example of <a
                        href="#">link anchor text</a> within body copy.</p>
            ...
            <div class="panel-body">
                ...
                <p>
                    <abbr title="HyperText Markup Language"
                          class="initialism">HTML</abbr>is an abbreviation for a programming language.</p>
                <br>
                <h4>Addresses</h4>
                <address>
